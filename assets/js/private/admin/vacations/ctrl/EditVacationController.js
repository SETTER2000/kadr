...
angular.module('VacationModule')
    .controller('EditVacationController', ['$scope', '$http', 'toastr', '$interval', '$state', 'Users', 'Vacations', 'moment', 'Schedules', 'Departments', '$stateParams', 'FileUploader', '$rootScope','calendarService',
        function ($scope, $http, toastr, $interval, $state, Users, Vacations, moment, Schedules, Departments, $stateParams, FileUploader, $rootScope,calendarService) {
            ...
            //};
            //
            //let calendarService = new Calendar();
