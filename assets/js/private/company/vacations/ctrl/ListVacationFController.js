            ...
            function ($scope, $location, ngDialog, $mdDialog, moment, $http, toastr, $rootScope, $timeout, $state, VacationsF, logService, errorService, calendarService) {
                ...
                $scope.clickToOpen = function () {
                    ngDialog.open({
                         ...
                         */
                        showClose: true,
                        template: '/js/private/company/vacations/views/popup.view.html',
                ...
                var tabs = [
                        ...
                        {
                            title: '01.10.2017 по 08.10.2017',
                ...
                console.log('DAYS F:', $scope.getDays());
                /**
                ...
                $scope.tableView = "/js/private/company/vacations/views/table.view.html";
                $scope.childrenView = "/js/private/company/vacations/views/children.view.html";
                $scope.actionView = "/js/private/company/vacations/views/action.view.html";
                $scope.workView = "/js/private/company/vacations/views/work.view.html";
                ...
                $scope.refresh = function (where) {
                    ...
                    $scope.items = VacationsF.query($scope.query, function (vacations) {
                        // console.log('VacationsF ITEMS22:', vacations);
                        $scope.objectName = [];
                ...
                breadcrumb.set('Vacations', '/company/' + $state.current.url);
