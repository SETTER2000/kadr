(function (angular) {
    ...
    angular.module('UserFModule')
        .controller('ListFController', ['$scope', '$location', 'moment', '$http', 'toastr', "$rootScope", '$timeout', '$state', 'UsersF', 'Attendances', '$window',
            function ($scope, $location, moment, $http, toastr, $rootScope, $timeout, $state, UsersF, Attendances) {
            ...
            $scope.showStr = 0;
            $scope.urlBt = 'home.company.users.create';
            ...
            //$scope.tableView = "/js/private/company/users/views/home.company.users.table.html";
            //$scope.listView = "/js/private/company/users/views/home.company.users.list.html";
            //$scope.actionView = "/js/private/company/users/views/home.company.users.action.html";
            //$scope.workView = "/js/private/company/users/views/home.company.users.work.html";
            ...
            breadcrumb.set('Users', '/company/' + $state.current.url);
